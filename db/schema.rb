...
ActiveRecord::Schema.define(version: 20180212140447) do
  ...
  create_table "admin_furniture_paint_color_brands", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["is_default"], name: "index_admin_furniture_paint_color_brands_on_is_default", using: :btree
  end
  ...
  create_table "admin_push_notifications", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "profiles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id"], name: "index_unique_user_id", unique: true, using: :btree
  end
