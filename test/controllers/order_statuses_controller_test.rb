...
class OrderStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_status" do
    assert_difference('OrderStatus.count') do
      post order_statuses_url, params: { order_status: { delivered_at: @order_status.delivered_at, shipped_at: @order_status.shipped_at, state: @order_status.state } }
    end
  ...
  test "should update order_status" do
    patch order_status_url(@order_status), params: { order_status: { delivered_at: @order_status.delivered_at, shipped_at: @order_status.shipped_at, state: @order_status.state } }
