...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post furnitures_url, params: { furniture: { comment: @furniture.comment, furnitaure_detail_id: @furniture.furnitaure_detail_id, furnitaure_wage_id: @furniture.furnitaure_wage_id, name: @furniture.name } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { comment: @furniture.comment, furnitaure_detail_id: @furniture.furnitaure_detail_id, furnitaure_wage_id: @furniture.furnitaure_wage_id, name: @furniture.name } }
