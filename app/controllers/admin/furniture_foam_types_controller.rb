class Admin::FurnitureFoamTypesController < Admin::AdminbaseController
  ...
  def index
    @admin_furniture_foam_types = Admin::FurnitureFoamType.all
  end

  # GET /admin/furniture_foam_types/new
  def new
    @admin_furniture_foam_type = Admin::FurnitureFoamType.new
  end
  ...
  def create
    @admin_furniture_foam_type = Admin::FurnitureFoamType.new(admin_furniture_foam_type_params)
  ...
  private
    ...
    def set_admin_furniture_foam_type
      @admin_furniture_foam_type = Admin::FurnitureFoamType.find(params[:id])
    end
