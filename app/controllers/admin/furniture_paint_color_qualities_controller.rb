class Admin::FurniturePaintColorQualitiesController < Admin::AdminbaseController
  ...
  def index
    @admin_furniture_paint_color_qualities = Admin::FurniturePaintColorQuality.all
  ...
  def new
    @admin_furniture_paint_color_quality = Admin::FurniturePaintColorQuality.new
  end
  ...
  def create
    @admin_furniture_paint_color_quality = Admin::FurniturePaintColorQuality.new(admin_furniture_paint_color_quality_params)
  ...
  private
    ...
    def set_admin_furniture_paint_color_quality
      @admin_furniture_paint_color_quality = Admin::FurniturePaintColorQuality.find(params[:id])
    end
