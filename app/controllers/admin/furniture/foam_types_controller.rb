class Admin::Furniture::FoamTypesController < Admin::AdminbaseController
  ...
  def new
    @admin_furniture_foam_type = Admin::Furniture::FoamType.new
  end
  ...
  def create
    @admin_furniture_foam_type = Admin::Furniture::FoamType.new(admin_furniture_foam_type_params)
  ...
  private
    ...
    def set_admin_furniture_foam_type
      @admin_furniture_foam_type = Admin::Furniture::FoamType.find(params[:id])
    end
