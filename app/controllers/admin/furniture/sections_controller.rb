class Admin::Furniture::SectionsController < Admin::UploaderController
  ...
  def index
    @admin_furniture_sections = Admin::Furniture::Section.all
  end

  # GET /admin/furniture_sections/new
  def new
    @admin_furniture_section = Admin::Furniture::Section.new
  end
  ...
  def create
    @admin_furniture_section = Admin::Furniture::Section.new(admin_furniture_section_params)
  ...
  private
    ...
    def set_admin_furniture_section
      @admin_furniture_section = Admin::Furniture::Section.find(params[:id])
    end
