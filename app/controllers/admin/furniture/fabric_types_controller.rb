class Admin::Furniture::FabricTypesController < Admin::AdminbaseController
  ...
  def index
    @admin_furniture_fabric_types = Admin::Furniture::FabricType.paginate(page: params[:page])
  ...
  def new
    @admin_furniture_fabric_type = Admin::Furniture::FabricType.new
  end
  ...
  def create
    @admin_furniture_fabric_type = Admin::Furniture::FabricType.new(admin_furniture_fabric_type_params)
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_furniture_fabric_types_path, notice: "نوع پارچه «<b>#{@admin_furniture_fabric_type.name}</b>» با موفقیت حذف شد." }
  ...
  private
    ...
    def set_admin_furniture_fabric_type
      @admin_furniture_fabric_type = Admin::Furniture::FabricType.find(params[:id])
    end
